(function ()
{
    ...
    function DashboardAnalyticsController(DashboardData, uiGmapGoogleMapApi)
    {
        ...
        vm.widget1 = {
            ...
            hittingPercentage       : vm.dashboardData.widget1.hittingPercentage,
            bigChart          : {
                options: {
                    chart: {
            ...
            totalErrors: {
                title   : vm.dashboardData.widget1.totalErrors.title,
                value   : vm.dashboardData.widget1.totalErrors.value,
                previous: vm.dashboardData.widget1.totalErrors.previous,
                options : {
                    chart: {
                        type                   : 'lineChart',
                        color                  : ['#009688'],
                ...
                data    : vm.dashboardData.widget1.totalErrors.chart
            }
